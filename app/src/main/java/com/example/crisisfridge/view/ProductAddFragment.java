...
public class ProductAddFragment extends ProductFragment {
    ...
    private List<String> productTypesToStrings(List<ProductType> productTypeList) {
        List<String> productTypesStr = new ArrayList<>();
        for (ProductType productType : productTypeList) {
            productTypesStr.add(productType.getName());
        }
        return productTypesStr;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, productTypesToStrings(productTypes));
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        inv_item_name_spinner.setAdapter(adapter);
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int productIndex = (int) inv_item_name_spinner.getSelectedItemId();
                        int productID = productTypes.get(productIndex).getId();

                        Intent intent = new Intent();
                        intent.putExtra(EXTRA_INV_ITEM_NUMBER, productID);
